 ...
 * @return {object} 执行结果
 * */
declare function nth(dataSource: [], index: number): any;
 ...
 * @return {void}
 * */
declare function each(dataSource: [], itemAction: () => void): void;
 ...
 * @return {object} 执行结果
 * */
declare function map(dataSource: [], itemAction: () => any): any[];
 ...
 * */
declare function construct(elem: any, arr: any[]): any[];
 ...
 * @return {object} 排序结果
 * */
declare function sortBy(dataSource: any[], pickup: (v: any) => number): any[];
 ...
 * @return {boolean} 运算结果
 * */
declare function allOf(dataSource: any[] | object, pred: (v: any) => boolean): boolean;
 ...
 * @return {boolean} 运算结果
 * */
declare function anyOf(dataSource:any[] | object, pred: (v: any) => boolean): boolean;
 ...
 * */
declare function filter(dataSource: any[] | object, pred: (v: any) => boolean): any[]; 
 ...
 * */
declare function find(dataSource: any[] | object, pred: (v: any) => boolean): any;
 ...
 * */
declare function complement(pred: (v: any) => boolean): (v: any) => boolean; 
 ...
 * @return {object} 排序结果
 * */
declare function groupBy(dataSource: any[] | object, pickup: (v : any) => string): object;
 ...
 * @return {object} 排序结果
 * */
declare function countBy(dataSource: any[] | object, pickup: (v: any) => string): object;
 ...
 * @return {array} 值的数组
 * */
declare function pluck(objects: any[] | object, targetKey: string): any[];
 ...
 * */
declare function best(dataSource: any[] | object, fun: (v: any) => boolean): any;
 ...
 * */
declare function comparator(pred: (x: any, y: any) => any): (x: any, y: any) => number;
 ...
 * */
declare function iterateUntil(feedForward: (value: any, index: number) => boolean, init: () => any): any[];
 ...
 * */
declare function fnull(fun: (...args: any) => any, ...args: any): (...args: any) => any;
...
interface validator{
  (message: string, fun: (...args) => boolean): (...args) => boolean;
}

declare function validator(message: string, fun: (...args) => boolean): (...args) => boolean;
 ...
 * */
declare function checker(...validators: validator[]): (targetValidationData: any) => any;
 ...
 * @return {array} 转换后的结果
 * */
declare function toArray(dataSource: object | Map<any, any> | any[]): any[];
 ...
 * @return {boolean} 参数是否为 Array 类型
 * */
declare function isIndexed(data: any): boolean;
 ...
 * */
declare function exist(x: any): boolean;
 ...
 * */
declare function truest(x: any): boolean;
 ...
 * @return {object} 执行结果
 * */
declare function doWhen(condition: any, action: () => any): any;
 ...
 * @return {object} 新对象
 * */
declare function duplicate(sourceObject: any) : any;
 ...
 * @return {void}
 * */
declare function documentWriteln(...args: any): void;

/**
 * 往 html 文档中写入内容
 * @return {void}
 * */
declare function documentWrite(...args: string[]): void;
 ...
 * @return {void}
 * */
declare function fail(thing: string): never;
 ...
 * @return {void}
 * */
declare function warning(thing: string): void;
 ...
 * @return {void}
 * */
declare function note(...args: string[]): void;
...
declare namespace G{
  ...
  function validator(message: string, fun: (...args) => boolean): (...args) => boolean;
